...
resource "aws_subnet" "levelupvpc-public-1" {
  ...
  availability_zone       = data.aws_availability_zone.my_az.name[0]
...
resource "aws_subnet" "levelupvpc-public-2" {
  ...
  map_public_ip_on_launch = "true"
  availability_zone       = data.aws_availability_zone.my_az.name[1]
...
resource "aws_subnet" "levelupvpc-public-3" {
  ...
  map_public_ip_on_launch = "true"
  availability_zone       = data.aws_availability_zone.my_az.name[2]
